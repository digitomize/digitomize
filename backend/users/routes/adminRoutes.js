...
import { createUserFirebase, createUserDB } from "../controllers/AdminUserController.js";
import { deleteUserFirebase, deleteUserDB } from "../controllers/AdminUserController.js";
...
router.delete("/user", [addUID, dgmAdminCheck], deleteUserFirebase, deleteUserDB);
