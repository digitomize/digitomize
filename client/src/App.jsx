  ...
  return (
    <div className="container">
      ...
      <div className="button-container">
        <h1>Your Ultimate Contest List</h1>
        <p>Crack the Code, Claim the Crown - Your Gateway to Coding Supremacy!</p>
        {/* Scroll to Contests button */}
        <Link to="contests" smooth={true} duration={500}>
          <button className="button" >go to contests<svg xmlns="http://www.w3.org/2000/svg" width="60" height="23" viewBox="0 0 60 23" fill="none">
