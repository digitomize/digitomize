    ...
    return (
      <div className="h-screen flex items-center justify-center z-30">
        <div className="text-2xl text-green-400 font-bold gap-x-4 flex">
          <div className="phonesm:text-xl  md:text-4xl bg-clip-text text-transparent pb-4 bg-gradient-to-tr from-green-400 to-white font-bold font-sans text-center relative z-10">
            Verifying User
          </div>
      ...
      <>
        <div className="relative z-30">
          ...
          <main className="h-screen flex flex-col items-center justify-center w-fit ml-auto mr-auto">
            ...
            >
              <span className="absolute inset-0 w-full h-full mt-1 ml-1 transition-all duration-300 ease-in-out bg-[#4285f4] rounded-md group-hover:mt-0 group-hover:ml-0" />
              <span className="absolute inset-0 w-full h-full bg-white rounded-md " />
              <span className="absolute inset-0 w-full h-full transition-all duration-200 ease-in-out delay-100 bg-[#4285f4] rounded-md opacity-0 group-hover:opacity-100" />
