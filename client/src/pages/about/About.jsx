            ...
            <div className="left text-center flex flex-col justify-center items-center">
              ...
              <div className="mt-[70px]">
                ...
                <div className="flex flex-row justify-between mt-[50px] flex-wrap gap-y-[25px] gap-x-[25px] ">
                  <div className="border-[1px] flex-1 border-solid border-white bg-[#0e0f10] min-w-[225px] text-white rounded-[12px] py-[30px] px-[25px] text-center hover:scale-110 transition-all">
                  ...
                  <div className="border-[1px] flex-1 border-solid border-white min-w-[225px] bg-[#0e0f10] text-white rounded-[12px] py-[30px] px-[25px] text-center hover:scale-110 transition-all">
                    <h3 className="font-semibold text-2xl mb-[20px]">
                      Portfolio
                    </h3>
                    <p className="text-[1rem]">
