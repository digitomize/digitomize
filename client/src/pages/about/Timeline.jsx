...
function MuiTimeline() {
  ...
  return (
    <>
      <div className="noCursor translate-y-1 bg-[#05225C]  rounded-[2px] text-[20px] px-[20px] py-[4px] lg:mx-auto w-fit ">{month} {year}</div>
      ...
      <div className="noCursor text-center -translate-y-10 bg-[#05225C] rounded-[2px] text-[20px] px-[20px] py-[4px] lg:mx-auto w-fit ">Aug 2023</div>
    </>
  );
}
