      ...
      <div className="flex flex-col sm:flex-row sm:space-x-20 space-y-8 sm:space-y-0 my-8">
        <div className="flex-1 mt-8">
          ...
          <p className="mt-3 font-light text-sm text-gray-500">
            Enter tags that represent your skills, tools, and preferred roles.
          </p>
        ...
        <div className="flex-2 rounded-lg shadow bg-dashboardColor border border-jet">
          <div className="px-6 py-8">
            <div className="sm:w-9/12">
              <label
                htmlFor="phoneNumber"
                className="phone:ml-1 text-xs font-medium text-secondary"
              >
                Please enter one tag at a time in the input box!
              </label>
              ...
              <div className="skillchips w-full max-sm:text-sm  max-w-3xl h-12 mt-2">
                {skillData.length > 0 ? (
                  ...
                  <p className="ml-1 text-xs font-medium text-secondary">
                    No tag added.
                  </p>
                )}
              </div>
