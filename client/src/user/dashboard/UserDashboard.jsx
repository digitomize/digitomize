                                        ...
                                        navLinks.map((navLink, index) => (
                                            <><li key={index}>
                                                <NavLink to={navLink.path} className="p-0 mt-2">
                                                    ...
                                                    <h2 className="my-auto flex items-center justify-evenly"> <span className="text-xl w-1/2"> {navLink.title}</span>   <KeyboardDoubleArrowRightIcon /></h2>

                                                </NavLink>
                                            </li><div className="divider w-4/5 self-center m-0 p-0"></div></>
                                        ))}
                                </ul>
                            </div>
