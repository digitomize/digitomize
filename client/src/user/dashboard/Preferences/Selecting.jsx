        ...
        <>
            <div className="flex flex-col sm:flex-row sm:space-x-20 space-y-8 sm:space-y-0 my-8">
                ...
                <div className="flex-1 mt-8">
                    <h3 className="text-base font-semibold text-gray-200">Select your platforms</h3>
                    <p className="mt-3 font-light text-sm text-gray-500">Customize your coding experience by selecting preferred platforms to suit your needs.</p>
