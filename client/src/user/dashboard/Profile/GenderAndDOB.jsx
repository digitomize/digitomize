        ...
        <>
            <div className="flex flex-col sm:flex-row sm:space-x-20 space-y-8 sm:space-y-0 my-8">
                <div className="flex-1 mt-8">
                    <h3 className="text-base font-semibold text-gray-200">Date of Birth</h3>
                    <p className="mt-3 font-light text-sm text-gray-500">Kindly provide your date of birth for accurate record-keeping.</p>
                ...
                <div className="flex-2 rounded-lg shadow bg-dashboardColor border border-jet">
                    <div className="px-6 py-8">
                        ...
                        <div className="sm:w-9/12">
                            <div className="label">
                                <label className="text-xs font-medium text-secondary">Date of Birth</label>
                            </div>
                            {
