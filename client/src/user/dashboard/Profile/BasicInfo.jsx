            ...
            <div className="flex flex-col sm:flex-row sm:space-x-5 items-center">
              <div className="flex-0 px-4 flex flex-col justify-center items-center h-28">
                <div className="relative text-center">
                  ...
                  />
                  <label className="mt-5 text-xs font-medium text-secondary text-center">
                    Upload
                  </label>
                </div>
              </div>
              ...
              <div className="flex-1 w-full">
                <label
                  className="ml-1 mt-5 text-xs font-medium text-secondary"
                  htmlFor="firstName"
                >
                  Display Name
                </label>
                <input
                  ...
                  placeholder="Bill"
                  className="border border-jet rounded px-3 py-[10px] w-full mt-2 text-sm"
                  required="required"
                  type="text"
                  value={formData.name}
                  name="name"
          ...
          <div className="px-6 py-8 border-b border-jet">
            <div className="sm:w-9/12">
              ...
              <input
                ...
                className="placeholder:text-gray-600 border border-jet rounded px-3 py-[10px] w-full mt-2 text-sm"
                type="email"
                name="email"
                id="email"
              />
            ...
            <div className="mt-5">
              <div className="sm:w-9/12">
                <div className="mt-5">
                  <label
                    htmlFor="phoneNumber"
                    className="ml-1 text-xs font-medium text-secondary"
                  >
                    Phone
                  </label>
                  <input
          ...
          <div className="px-6 py-8">
            <div className="sm:w-9/12">
              <div className="label">
                ...
                <label className="ml-1 text-xs font-medium text-secondary">
                  {formData.bio?.data?.length || 0}/{BIO_LIMIT}
                </label>
              </div>
              <textarea
                style={{ backgroundColor: "RGB(17, 19, 18)" }}
                className="placeholder:text-gray-600 textarea textarea-bordered h-24 w-full"
                placeholder="Ex: Developer @ digitomize"
                maxLength={BIO_LIMIT}
                onChange={handleInputChangeObjData}
