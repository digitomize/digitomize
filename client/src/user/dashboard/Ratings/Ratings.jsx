      ...
      <div className="container bg-dashboardDarkColor font-['Geist'] w-auto">
        <div className="flex justify-between items-center min-h-[40px]">
          <div className="flex flex-shrink gap-2 mr-4 items-center min-w-0">
            <p className="truncate font-medium text-gray-200 text-3xl max-w-[600px] max-phone:hidden">
              Integrate your ratings
            </p>
            <p className="truncate font-medium text-gray-200 text-3xl max-w-[600px] phone:hidden">
              Ratings
            </p>
          </div>
        </div>
