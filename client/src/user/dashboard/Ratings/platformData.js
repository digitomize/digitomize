...
const platforms = [
    {
        ...
        content: "Connect your Leetcode profile to showcase your problem-solving achievements!",
        icon: leetcode,
        url: "leetcode.com/",
        name: "leetcode",
    ...
    },
    {
        ...
        content: "Link your Codechef profile to display your coding competition rankings!",
        icon: codechef,
    ...
    },
    {
        ...
        content: "Connect your Codeforces account to showcase your algorithmic contest history!",
        icon: codeforces,
    ...
    },
    {
        ...
        content: "Link your Atcoder account to display your competitive programming progress!",
        icon: atcoder,
    ...
    },
    {
        ...
        content: "Merge your GeeksforGeeks account to compile your coding article bookmarks!",
        icon: geeksforgeeks,
    ...
    },
    {
        ...
        content: "Sync your Coding Ninjas profile to track your coding course progress!",
        icon: codingninjas,
