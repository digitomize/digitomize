        ...
        <div className="sm:w-96 bg-dashboardColor">
          <div className="border rounded-t-lg border border-jet px-4 py-6 w-full">
            <div className="flex flex-col items-center mb-2">
              ...
              <h3 className="text-base font-semibold text-gray-200 mt-2">
                {platform.title}
              </h3>
            ...
            <div>
              <div className="border border-jet rounded px-3 py-1 w-full text-sm transition duration-150 ease-in-out flex items-center flex font-light overflow-hidden bg-dashboardDarkerColor">
                <label
                  htmlFor="Instagram"
                  className="select-none text-gray placeholder-gray-gray4 "
                >
                ...
                <input
                  autoComplete="off"
                  type="text"
                  className="placeholder:text-gray-600 outline-none border-0 rounded-md font-medium w-full bg-dashboardDarkerColor text-sm px-0"
                  value={formData[platform.name]?.username}
                  placeholder=""
