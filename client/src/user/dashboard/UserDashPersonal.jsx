...
export default function UserDashPersonal() {
  ...
  return (
    <div className='container px-8 md:ps-12 py-12'>
        ...
        <div className="grid md:grid-cols-2 md:gap-2">
            ...
            <div className="relative z-0 w-full md:w-3/4 mb-12 group">
                <input type="date" name="dateOfBirth" id="dateOfBirth" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"  required />
        ...
        <button type="submit" className="text-white gradient-custom font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center ">Update</button>
        </Form>
