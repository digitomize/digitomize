...
function SignoutButton({
  ...
  return (
    <div className="noCursor w-full flex justify-center px-4 py-4">
      <button
        onClick={onClickFunction}
        disabled={btnState}
        className="noCursor relative inline-flex items-center justify-center px-6 py-2 text-lg font-medium tracking-tighter text-white bg-gray-800 rounded-md group min-w-2/5"
      >
        <span
        ...
        ></span>
        <span className="noCursor absolute inset-0 w-full h-full bg-white rounded-md "></span>
        <span
        ...
        ></span>
        <span className="noCursor relative text-black transition-colors duration-200 ease-in-out delay-100 group-hover:text-white">
