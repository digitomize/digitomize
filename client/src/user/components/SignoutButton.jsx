...
function SignoutButton({btnName, isDisabled}) {
    ...
    return (
        <div className="w-full flex justify-end px-4 py-4">
            <button onClick={handleLogout} disabled={isDisabled} className="relative inline-flex items-center justify-center px-6 py-2 text-lg font-medium tracking-tighter text-white bg-gray-800 rounded-md group">
