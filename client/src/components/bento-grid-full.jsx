...
const SkeletonFour = ({ ratings }) => {
  ...
  return (
    ...
    >
      <FollowerPointerCard className={"w-1/3"} title={
        <TitleComponent
          title={"codechef"}
          avatar={codechef}
        />
        ...
        <motion.div
          variants={first}
          className="h-full rounded-2xl bg-white p-4 dark:bg-dashboardDarkerColor dark:border-white/[0.1] border border-neutral-200 flex flex-col items-center justify-center"
        >
          <img
            src={codechef}
            alt="avatar"
      ...
      <motion.div className="h-full relative z-20 w-1/3 rounded-2xl bg-white p-4 dark:bg-dashboardColor dark:border-white/[0.1] border border-neutral-200 flex flex-col items-center justify-center">
        <img
          src={codeforces}
          alt="avatar"
          height="100"
      ...
      <motion.div
        variants={second}
        className="h-full w-1/3 rounded-2xl bg-white p-4 dark:bg-dashboardDarkerColor dark:border-white/[0.1] border border-neutral-200 flex flex-col items-center justify-center"
      >
        <img
          src={leetcode}
          alt="avatar"
