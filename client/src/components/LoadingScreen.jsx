        ...
        <>
            <div className="m-auto flex flex-col items-cente r w-4/5 py-12">
                ...
                <div className="mockup-code w-2/4 mx-auto">
                    <pre data-prefix="$"><code className="text-white">import</code> <code className="text-red">"{window.location.pathname}"</code></pre>
                ...
                <div className="buttons my-3 flex gap-3 mx-auto">
                    <button className="btn lowercase" disabled={isRefreshBtnDisabled} onClick={() => window.location.reload()}>
                        <Refresh />
                        refresh in 10s
                    </button>
                    {logout &&
