    ...
    <div className="container flex flex-col mx-auto">
      ...
      <div className="button-container scroll-smooth h-[85vh] flex flex-col justify-center items-center z-[1] max-md:h-[80vh]">
        ...
        <Link to="newHead" smooth={true} duration={500}>
          <button className="btn md:w-96 h-24 bg-white text-black rounded-full cursor-pointer md:text-4xl font-semibold flex flex-row items-center justify-center mt-8 max-md:w-80 max-md:text-2xl">
            go to contests
            <svg
