...
export default function SectionThree() {
  return (
    <div className="contestlist font-['Geist']">
      <div className='hero min-h-screen flex flex-col w-10/12 mx-auto '>
        <div className='right phone:w-3/5 flex flex-col z-10'>
          <div className='phone:text-right max-phone:text-center'>
            <h1 className='sm:text-8xl max-sm:text-5xl my-0 font-medium'>
              upcoming{" "}
              <span className='text-custom-blue font-bold'>contest</span> list
            </h1>
          </div>
          <div className='description'>
            <p className='py-6 text-xl phone:text-right max-phone:text-center'>
