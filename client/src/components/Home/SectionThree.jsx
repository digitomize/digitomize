      ...
      <div className="hero flex flex-col">
        <div className="">
          <div className="my-24 mx-auto">
            ...
            <p className="text-center mt-8 text-description max-w-2xl mx-auto">filter contests based on various criteria and view contest details such as remaining time, duration, and more.</p>
