    ...
    <>
      ...
      {true && (
        <div className='mx-auto mt-4 w-fit'>
          ...
          {/* <div className="flex w-full md:flex-row-reverse -right-8 -top-4 md:relative max-md:justify-center max-md:mt-4">
      ...
      {isMobile ? (
        <div className='py-8 '>
          <div className='mx-4 card_Navigation'>
        ...
        <>
          <div className='flex justify-center mt-8 text-2xl card_Navigation'>
            <div className='card_nav_path'>
              <Link to='/'>
                <HomeIcon sx={{ mr: 0.5 }} fontSize='inherit' />
                Home
