...
export default function Footer() {
  return (
    <footer className=" font-['Geist'] bg-[#071F54] pb-10">
      ...
      <div className="lg:flex-1 flex flex-col sm:flex-row sm:flex-wrap mx-auto justify-between gap-8 mb-4 sm:mb-0">
        ...
        <nav className="flex justify-center items-center sm:!items-start flex-col gap-3">
          ...
          <div className="flex gap-3">
            ...
            >
              <svg width="32" height="33" viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fillRule="evenodd" clipRule="evenodd" d="M21.9076 2.30518H10.0923C5.74195 2.30518 2.21533 5.83179 2.21533 10.1821V21.9975C2.21533 26.3477 5.74195 29.8744 10.0923 29.8744H21.9076C26.2579 29.8744 29.7846 26.3477 29.7846 21.9975V10.1821C29.7846 5.83179 26.2579 2.30518 21.9076 2.30518Z" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                <path fillRule="evenodd" clipRule="evenodd" d="M16 21.9975C12.7372 21.9975 10.0923 19.3526 10.0923 16.0898C10.0923 12.827 12.7372 10.1821 16 10.1821C19.2628 10.1821 21.9077 12.827 21.9077 16.0898C21.9077 17.6565 21.2852 19.1593 20.1773 20.2671C19.0694 21.375 17.5667 21.9975 16 21.9975Z" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M23.8769 6.24367C22.7894 6.24367 21.9077 7.12532 21.9077 8.2129C21.9077 9.30047 22.7894 10.1821 23.8769 10.1821C24.9645 10.1821 25.8462 9.30047 25.8462 8.2129C25.8462 7.12532 24.9645 6.24367 23.8769 6.24367Z" fill="white" />
              </svg>
