...
export default function Footer() {
  return (
    <footer className=" font-['Geist'] bg-[#071F54] pb-10 mt-6">
      <div className="footer lg:max-w-7xl mx-auto p-10 text-base-content md:items-center flex flex-col md:flex-row justify-center items-start">
        <aside className="flex flex-col m-auto sm:!ml-0 md:mr-8 text-center sm:text-start mb-4 sm:mb-0  md:!my-auto">
          <img
            width="100"
            height="100"
            src={logo}
            alt="logo"
            className="rounded-full w-16 m-auto sm:!ml-0"
          />
          <div>
      ...
      <div className="lg:flex-1 flex flex-col sm:flex-row sm:flex-wrap mx-auto justify-between gap-8 mb-4 sm:mb-0">
        <nav className="flex justify-center items-center sm:!items-start flex-col gap-3">
          <header className="text-white font-medium text-2xl mb-2">Competitions</header>
          <a
            href="/contests"
        ...
        <nav className="flex justify-center items-center sm:!items-start flex-col gap-3">
          <header className="text-white font-medium text-2xl mb-2">Opportunities</header>
          <a
            href="/internships"
            className="link link-hover hover:no-underline hover:text-custom-blue hover:scale-110 transition-all text-lg"
          >
        ...
        <nav className="flex justify-center items-center sm:!items-start flex-col gap-3">
          <header className="text-white font-medium text-2xl mb-2">Connect</header>
          <a
            href="/feedback"
            className="link link-hover hover:no-underline hover:text-custom-blue hover:scale-110 transition-all text-lg"
          >
        ...
        <nav className="flex justify-center items-center sm:!items-start flex-col gap-3">
          <header className="text-white font-medium text-2xl mb-2">Social</header>
          <div className="flex gap-3">
            ...
            <a
              ...
              target="_blank" rel="noopener noreferrer"
            >
              <svg width="32" height="33" viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg" className="fill-white hover:fill-custom-blue">
                <path fillRule="evenodd" clipRule="evenodd" d="M10.064 28.8895C22.1392 28.8895 28.744 19.0392 28.744 10.4981C28.744 10.2177 28.744 9.93937 28.7248 9.66212C30.0096 8.74846 31.1184 7.61405 32 6.31603C30.8032 6.83902 29.5312 7.182 28.2304 7.33322C29.6 6.52511 30.6256 5.25552 31.1168 3.75744C29.8272 4.51041 28.4176 5.04183 26.9472 5.32697C24.4608 2.72461 20.3024 2.59853 17.6576 5.0465C15.9536 6.62491 15.2288 8.97831 15.7584 11.2231C10.48 10.9616 5.5616 8.50734 2.2272 4.46994C0.4848 7.42355 1.376 11.2007 4.2608 13.0973C3.216 13.0673 2.1936 12.7904 1.28 12.2895V12.3715C1.2816 15.448 3.4848 18.097 6.5472 18.7067C5.5808 18.9666 4.5664 19.0043 3.584 18.8168C4.4432 21.4507 6.9088 23.2547 9.7168 23.3067C7.392 25.1056 4.52 26.0824 1.5632 26.0793C1.0416 26.0777 0.52 26.0478 0 25.9863C3.0032 27.883 6.496 28.8895 10.064 28.8848" fill="inherit" />
              </svg>
            ...
            <a
              ...
              target="_blank" rel="noopener noreferrer"
            >
              <svg width="32" height="33" viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg" className="group">
                <path fillRule="evenodd" clipRule="evenodd" d="M21.9076 2.30518H10.0923C5.74195 2.30518 2.21533 5.83179 2.21533 10.1821V21.9975C2.21533 26.3477 5.74195 29.8744 10.0923 29.8744H21.9076C26.2579 29.8744 29.7846 26.3477 29.7846 21.9975V10.1821C29.7846 5.83179 26.2579 2.30518 21.9076 2.30518Z" className="stroke-white group-hover:stroke-custom-blue" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                <path fillRule="evenodd" clipRule="evenodd" d="M16 21.9975C12.7372 21.9975 10.0923 19.3526 10.0923 16.0898C10.0923 12.827 12.7372 10.1821 16 10.1821C19.2628 10.1821 21.9077 12.827 21.9077 16.0898C21.9077 17.6565 21.2852 19.1593 20.1773 20.2671C19.0694 21.375 17.5667 21.9975 16 21.9975Z" className="stroke-white group-hover:stroke-custom-blue" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M23.8769 6.24367C22.7894 6.24367 21.9077 7.12532 21.9077 8.2129C21.9077 9.30047 22.7894 10.1821 23.8769 10.1821C24.9645 10.1821 25.8462 9.30047 25.8462 8.2129C25.8462 7.12532 24.9645 6.24367 23.8769 6.24367Z" className="fill-white group-hover:fill-custom-blue" />
              </svg>
      ...
      <p className="text-center w-full text-sm">&copy; 2023 Digitomize. All rights reserved. | This project is open source. View on <a href="https://github.com/digitomize/digitomize" target="_blank" rel="noopener noreferrer" className="underline">GitHub</a>.</p>
    </footer>
  );
}
