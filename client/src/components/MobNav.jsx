                ...
                <div className="flex items-center justify-between">
                    ...
                    >
                        ...
                        <div className="flex flex-col mt-6 divide-y divide-white/5 border-y border-y-white/5">
                            {user &&
                                <a className="flex items-center gap-2 py-4 font-display text-lg font-medium" href={dashboardLink.path} onClick={toggleActive}>
                                    {dashboardLink.title}
                                </a>
                            }
                            {navLinks.map((navLink, index) => (
                                <a className="flex items-center gap-2 py-4 font-display text-lg font-medium" key={index} href={navLink.path} onClick={toggleActive}>
                                    {navLink.title}
                                </a>
                            ))}
                        </div>
