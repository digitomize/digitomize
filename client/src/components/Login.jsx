                        ...
                        >
                            <div className="flex flex-col gap-5">
                                <div className="w-full px-3">
                                    ...
                                    <input type="text" placeholder="you@email.com" className="input input-bordered w-full bg-black border-2 border-jet" onChange={(e) => setEmail(e.target.value)} required />
                                </div>
                                <div className="w-full px-3">
                                    <label className="label">
                                        <span className="label-text">What is your name?</span>
                                    </label>
                                    <input type="text" className="input input-bordered w-full bg-black border-2 border-jet" onChange={(e) => setPassword(e.target.value)} placeholder="******************" required />
                                    <label className="label">
                            ...
                            <div className="items-center">
                                ...
                                <div className="new-user text-center mb-4">
                                    <p>new user? <span className="text-custom-blue">signup</span></p>
                                </div>
                            </div>
                        </Form>
                    </div>
