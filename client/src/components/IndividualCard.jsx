    ...
    <>
      ...
      {true &&
        <div className="noCursor mx-auto w-fit mt-4">
          <Alert severity="warning" className="noCursor w-fit" icon={<Star className="noCursor animate-ping" />}>
            <a href="https://github.com/digitomize/digitomize" target="_blank" rel="noreferrer">
              <AlertTitle>
                {/* <strong>🎉 digitomize</strong> */}
                <span className="noCursor normal-case"> Thank you for <strong>100+ stars</strong> on GitHub 🎉🎉
                </span>
              </AlertTitle>
            </a>
          </Alert>
      ...
      {isMobile ?
              ...
              <div className='ic-mv' key={vanity} style={{ backgroundColor: colorTheme }}>
                <div className='ic-mv-child'>
                  ...
                  <div className='ic-mv-child-third'>
                    ...
                    <div className='ic-mv-child-third-second'><svg xmlns="http://www.w3.org/2000/svg" width="6" height="6" fill="currentColor" className="noCursor bi bi-square-fill" viewBox="0 0 16 16"> <path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2z" /> </svg><svg xmlns="http://www.w3.org/2000/svg" width="6" height="6" fill="currentColor" className="noCursor bi bi-square-fill" viewBox="0 0 16 16"> <path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2z" /> </svg><svg xmlns="http://www.w3.org/2000/svg" width="6" height="6" fill="currentColor" className="noCursor bi bi-square-fill" viewBox="0 0 16 16"> <path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2z" /> </svg><svg xmlns="http://www.w3.org/2000/svg" width="6" height="6" fill="currentColor" className="noCursor bi bi-square-fill" viewBox="0 0 16 16"> <path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2z" /> </svg></div>
                    ...
                    <div className='ic-mv-child-third-fourth'><svg xmlns="http://www.w3.org/2000/svg" width="6" height="6" fill="currentColor" className="noCursor bi bi-square-fill" viewBox="0 0 16 16"> <path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2z" /> </svg><svg xmlns="http://www.w3.org/2000/svg" width="6" height="6" fill="currentColor" className="noCursor bi bi-square-fill" viewBox="0 0 16 16"> <path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2z" /> </svg><svg xmlns="http://www.w3.org/2000/svg" width="6" height="6" fill="currentColor" className="noCursor bi bi-square-fill" viewBox="0 0 16 16"> <path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2z" /> </svg><svg xmlns="http://www.w3.org/2000/svg" width="6" height="6" fill="currentColor" className="noCursor bi bi-square-fill" viewBox="0 0 16 16"> <path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2z" /> </svg></div>
                  ...
                  <div className='ic-mv-child-fourth'>
                    <svg xmlns="http://www.w3.org/2000/svg" style={{ display: "inline-block" }} width="20" height="20" fill="currentColor" className="noCursor bi bi-alarm" viewBox="0 0 16 16"><path d="M8.5 5.5a.5.5 0 0 0-1 0v3.362l-1.429 2.38a.5.5 0 1 0 .858.515l1.5-2.5A.5.5 0 0 0 8.5 9V5.5z" /><path d="M6.5 0a.5.5 0 0 0 0 1H7v1.07a7.001 7.001 0 0 0-3.273 12.474l-.602.602a.5.5 0 0 0 .707.708l.746-.746A6.97 6.97 0 0 0 8 16a6.97 6.97 0 0 0 3.422-.892l.746.746a.5.5 0 0 0 .707-.708l-.601-.602A7.001 7.001 0 0 0 9 2.07V1h.5a.5.5 0 0 0 0-1h-3zm1.038 3.018a6.093 6.093 0 0 1 .924 0 6 6 0 1 1-.924 0zM0 3.5c0 .753.333 1.429.86 1.887A8.035 8.035 0 0 1 4.387 1.86 2.5 2.5 0 0 0 0 3.5zM13.5 1c-.753 0-1.429.333-1.887.86a8.035 8.035 0 0 1 3.527 3.527A2.5 2.5 0 0 0 13.5 1z" /></svg>{remaningTime}
                  </div>
                  <div className='ic-mv-child-fifth'>
                    <a href={url} target="_blank" rel="noopener noreferrer" className="noCursor mv-btn-div" style={{ boxShadow: `0.5rem 0.5rem ${colorTheme}` }}>
                      <button style={{ color: "black", fontWeight: "bold", fontSize: "1.25rem", marginTop: "1.063rem" }}>participate</button>
                    </a>
                    <CopyToClipboard msg="share" className="noCursor mv-btn-div share-button-div share-button-container mv-btn-share-div" gradient={"mv-btn-div"} />
                  </div>
                </div>
              </div>
            </div>
        ...
        (<>
          ...
          <div className="noCursor ic py-8" key={vanity} style={{ backgroundColor: colorTheme }}>
            <div className="noCursor ic-child">
              ...
              <div style={{ position: "absolute", left: "350px", top: "530px" }}><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" className="noCursor bi bi-scissors" viewBox="0 0 16 16">
                <path d="M3.5 3.5c-.614-.884-.074-1.962.858-2.5L8 7.226 11.642 1c.932.538 1.472 1.616.858 2.5L8.81 8.61l1.556 2.661a2.5 2.5 0 1 1-.794.637L8 9.73l-1.572 2.177a2.5 2.5 0 1 1-.794-.637L7.19 8.61 3.5 3.5zm2.5 10a1.5 1.5 0 1 0-3 0 1.5 1.5 0 0 0 3 0zm7 0a1.5 1.5 0 1 0-3 0 1.5 1.5 0 0 0 3 0z" />
              </svg></div>
              <div style={{ position: "absolute", left: "348px", top: "10px", transform: "rotate(-180deg)" }}><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" className="noCursor bi bi-scissors" viewBox="0 0 16 16">
                <path d="M3.5 3.5c-.614-.884-.074-1.962.858-2.5L8 7.226 11.642 1c.932.538 1.472 1.616.858 2.5L8.81 8.61l1.556 2.661a2.5 2.5 0 1 1-.794.637L8 9.73l-1.572 2.177a2.5 2.5 0 1 1-.794-.637L7.19 8.61 3.5 3.5zm2.5 10a1.5 1.5 0 1 0-3 0 1.5 1.5 0 0 0 3 0zm7 0a1.5 1.5 0 1 0-3 0 1.5 1.5 0 0 0 3 0z" />
              </svg></div>
              <div className='ic-child-left'>
                ...
                <div className='ic-child-left-second'><svg xmlns="http://www.w3.org/2000/svg" width="5" height="5" fill="currentColor" className="noCursor bi bi-square-fill left-filled-box" viewBox="0 0 16 16"><path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2z" /></svg><svg xmlns="http://www.w3.org/2000/svg" width="5" height="5" fill="currentColor" className="noCursor bi bi-square-fill left-filled-box" viewBox="0 0 16 16"><path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2z" /></svg><svg xmlns="http://www.w3.org/2000/svg" width="5" height="5" fill="currentColor" className="noCursor bi bi-square-fill left-filled-box" viewBox="0 0 16 16"><path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2z" /></svg><svg xmlns="http://www.w3.org/2000/svg" width="5" height="5" fill="currentColor" className="noCursor bi bi-square-fill left-filled-box" viewBox="0 0 16 16"><path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2z" /></svg><svg xmlns="http://www.w3.org/2000/svg" width="5" height="5" fill="currentColor" className="noCursor bi bi-square-fill left-filled-box" viewBox="0 0 16 16"><path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2z" /></svg><svg xmlns="http://www.w3.org/2000/svg" width="5" height="5" fill="currentColor" className="noCursor bi bi-square-fill left-filled-box" viewBox="0 0 16 16"><path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2z" /></svg><svg xmlns="http://www.w3.org/2000/svg" width="5" height="5" fill="currentColor" className="noCursor bi bi-square-fill left-filled-box" viewBox="0 0 16 16"><path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2z" /></svg></div>
                ...
                <div className='ic-child-left-sixth'><svg xmlns="http://www.w3.org/2000/svg" width="5" height="5" fill="currentColor" className="noCursor bi bi-square-fill left-filled-box" viewBox="0 0 16 16"><path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2z" /></svg><svg xmlns="http://www.w3.org/2000/svg" width="5" height="5" fill="currentColor" className="noCursor bi bi-square-fill left-filled-box" viewBox="0 0 16 16"><path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2z" /></svg><svg xmlns="http://www.w3.org/2000/svg" width="5" height="5" fill="currentColor" className="noCursor bi bi-square-fill left-filled-box" viewBox="0 0 16 16"><path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2z" /></svg><svg xmlns="http://www.w3.org/2000/svg" width="5" height="5" fill="currentColor" className="noCursor bi bi-square-fill left-filled-box" viewBox="0 0 16 16"><path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2z" /></svg><svg xmlns="http://www.w3.org/2000/svg" width="5" height="5" fill="currentColor" className="noCursor bi bi-square-fill left-filled-box" viewBox="0 0 16 16"><path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2z" /></svg><svg xmlns="http://www.w3.org/2000/svg" width="5" height="5" fill="currentColor" className="noCursor bi bi-square-fill left-filled-box" viewBox="0 0 16 16"><path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2z" /></svg><svg xmlns="http://www.w3.org/2000/svg" width="5" height="5" fill="currentColor" className="noCursor bi bi-square-fill left-filled-box" viewBox="0 0 16 16"><path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2z" /></svg></div>
              ...
              <div className='ic-child-right'>
                ...
                <div className='ic-child-right-third'><svg xmlns="http://www.w3.org/2000/svg" style={{ display: "inline-block" }} width="20" height="20" fill="currentColor" className="noCursor bi bi-alarm" viewBox="0 0 16 16"><path d="M8.5 5.5a.5.5 0 0 0-1 0v3.362l-1.429 2.38a.5.5 0 1 0 .858.515l1.5-2.5A.5.5 0 0 0 8.5 9V5.5z" /><path d="M6.5 0a.5.5 0 0 0 0 1H7v1.07a7.001 7.001 0 0 0-3.273 12.474l-.602.602a.5.5 0 0 0 .707.708l.746-.746A6.97 6.97 0 0 0 8 16a6.97 6.97 0 0 0 3.422-.892l.746.746a.5.5 0 0 0 .707-.708l-.601-.602A7.001 7.001 0 0 0 9 2.07V1h.5a.5.5 0 0 0 0-1h-3zm1.038 3.018a6.093 6.093 0 0 1 .924 0 6 6 0 1 1-.924 0zM0 3.5c0 .753.333 1.429.86 1.887A8.035 8.035 0 0 1 4.387 1.86 2.5 2.5 0 0 0 0 3.5zM13.5 1c-.753 0-1.429.333-1.887.86a8.035 8.035 0 0 1 3.527 3.527A2.5 2.5 0 0 0 13.5 1z" /></svg>{remaningTime}</div>
                <div className='ic-child-right-fourth'>
                  <a href={url} target="_blank" rel="noopener noreferrer" className="noCursor btn-div" style={{ boxShadow: `8px 8px ${colorTheme}` }}>
