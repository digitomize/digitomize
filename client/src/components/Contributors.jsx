    ...
    <>
      <CssVarsProvider defaultMode='dark'>
        <div className='flex flex-col w-full gap-2 p-2'>
          <h1 className='p-0 m-0 max-phone:text-4xl'>Contributors</h1>
                  ...
                  <SwiperSlide key={item.name} className='w-fit'>
                    <Link to={item.profile}>
                      <Card
                        ...
                        className='my-2 w-fit hover:scale-105'
                        size='sm'
                        key={item.title}
                        variant='outlined'
                      >
                        ...
                        >
                          ...
                          <div className='flex flex-col gap-1 github'>
        ...
        {/* <div className="flex-col w-full px-2 max-phone:flex phone:hidden">
                    <div className="flex flex-row">
                        <Swiper
                            spaceBetween={10}
                            slidesPerView={3.5}
                                    ...
                                    <SwiperSlide key={item.name} className="w-fit">
                                        <Card orientation="horizontal" className="w-fit" size="sm" key={item.title} variant="outlined">
                                            ...
                                            <Box sx={{ whiteSpace: 'nowrap', mx: 1 }} className="max-phone:hidden">
                                                ...
                                                <div className="flex flex-row items-center gap-1 github">
                                                    <AiFillGithub />
