                                ...
                                <div className="w-full">
                                    <SwiperSlide key={item.name} className="w-fit">
                                        <Link to={item.profile}>
                                            <Card orientation="horizontal" className="w-full hover:scale-105 overflow-hidden" size="sm" key={item.title} variant="outlined">
                                                ...
                                                <Box sx={{ whiteSpace: 'nowrap', mx: 1 }} className="max-phone:hidden flex flex-col items-start justify-start">
